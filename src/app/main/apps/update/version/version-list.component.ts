...
export class VersionListComponent extends CoreListComponent
{
    ...
    displayedColumns = ['update_version.id', 'update_version.name', 'admin_package.name', 'update_version.composer', 'update_version.migration', 'update_version.version', 'update_version.minimal_panel_version', 'update_version.provide', 'actions'];
