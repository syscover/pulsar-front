...
export class VersionListComponent extends CoreListComponent
{
    ...
    displayedColumns = ['update_versions.id', 'update_versions.name', 'admin_package.name', 'update_versions.composer', 'update_versions.migration', 'update_versions.version', 'update_versions.provide', 'actions'];
