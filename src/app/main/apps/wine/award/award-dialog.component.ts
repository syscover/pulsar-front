...
export class AwardDialogComponent implements OnInit
{
    ...
    constructor(
        ...
        private _dialogRef: MatDialogRef<AwardDialogComponent>,
        ...
        if (this.fg.valid)
        {
            ...
            const ob$ = this._http
                ...
                .subscribe(res => {
                    ...
                    this._dialogRef.close(res.data.wineCreateAward);
                });
        }
    }
