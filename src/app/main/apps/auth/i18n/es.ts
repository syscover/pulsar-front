export const locale = {
    ...
    data: {
        'AUTH': {
            ...
            'WELCOME_INTRODUCTION_04': '<span class="excerpt">Nunca olvides que...</span><br><br>Las inteligencias poco capaces se interesan en lo extraordinario; las inteligencias poderosas, en las cosas ordinarias.',
