...
export class TerritorialArea2ListComponent extends CoreListComponent
{
    ...
    columnsSearch: string[] = ['admin_territorial_area_2.id', 'admin_territorial_area_2.name', 'admin_territorial_area_2.slug'];
    displayedColumns = ['admin_territorial_area_2.id', 'admin_territorial_area_2.name', 'actions'];
